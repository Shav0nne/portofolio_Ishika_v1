                ...
                <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-xl text-yellow-400 gap-top-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <FadeInScale delay={800}>
                    <div className="bg-gray-800 rounded-2xl p-8 hover:translate-y-[-8px] hover:shadow-xl transition-all duration-300">
                        <h2 className="text-3xl font-bold text-yellow-400 mb-6 text-center">Fun Fact about</h2>
                        <div className="text-center space-y-4">
                            <p className="text-gray-300 leading-relaxed">
                                The theme of this portfolio is inspired from the video game Persona 4 Golden. It is my all time favorite game! The characters, story,
                                and the whole aesthetic of Inaba have inspired my portfolio design. This game meant a lot to me and it describes me as a person as well
                            </p>
                        </div>
                    </div>
                </FadeInScale>
